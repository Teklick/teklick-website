...
const featureData: FeatureType[] = [
  {
    ...
    description:
      'Our expertise in web development, mobile development, artificial intelligence, and machine learning allows us to understand your vision and turn it into a comprehensive and effective digital strategy.',
    tag: 'YOUR TECH PARTNER'
  },
  {
    image: agencyImg2,
    title: 'More than Just a Service Provider !',
